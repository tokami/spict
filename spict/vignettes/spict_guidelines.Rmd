...
| v 1.3            | v 1.3.8       |              Adjusted after WKLIFEXII |
...
Accompanying sample code assumes that

- input data is contained in a list called `inp`,
- results are contained in a list called `fit` after fitting SPiCT to the input
data with `fit <- fit.spict(inp)`, and
- one-step-ahead residuals were calculated with `fit <-
calc.osa.resid(fit)`.
