...
retape.spict <- function(rep, inp, verbose = TRUE, dbg = 0){
    ...
    if(verbose && !all(check)) stop("Some vectors in the input list 'inp' do not have the same length. Try to run 'check.man.time'!")
