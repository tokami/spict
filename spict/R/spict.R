...
make.datin <- function(inp, dbg=0){
    datin <- list(reportall=as.numeric(inp$reportall),
                  ...
                  seasonsSP=inp$seasonsSP,
                  nseasonsSP=inp$nseasonsSP,
                  seasonindexSP=inp$seasonindexSP,
                  ...
                  MSEmode=inp$MSEmode,
##                  pensdSP=inp$pensdSP,
                  indmanstart=inp$indmanstart,
                  indmanend=inp$indmanend,                   
                  ...
                  priorlogamp=inp$priors$logamp,
                  priorphase=inp$priors$phase,
                  simple=inp$simple,
                  dbg=dbg)
    return(datin)
}
